...
export const uk: Translation = {
  ...
  presence: {
    title: 'Присутність',
    description:
      'Бачити миттєво, коли друг по коопу онлайн, і отримувати сповіщення одразу, як тільки він вивантажить сейв — замість очікування періодичної перевірки. Опційно, вимкнено за замовчуванням.',
    enable: 'Увімкнути присутність',
    disable: 'Вимкнути',
    statusOff: 'Вимкнено',
