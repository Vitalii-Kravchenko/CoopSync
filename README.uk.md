...
<p align="center">
  <img src="https://img.shields.io/badge/версія-0.9.38-8A6CFF?style=flat-square&labelColor=10131C" alt="Версія">
...
за сервіс синхронізації заради такої простої речі здавалось зайвим. Тож я зробив CoopSync: він
сам пушить твій сейв у власний приватний репозиторій на GitHub прямо під час гри (і ще раз, коли
виходиш — про всяк випадок); запускаєш гру — спершу підтягується найновіша версія. Жодного мого сервера посередині, жодної оплати — просто твій
...
- 🌍 **10 мов** — англійська, французька, німецька, польська, португальська (Бразилія),
  російська, китайська (спрощена), іспанська, турецька та українська. Змінюється в будь-який
  момент у Налаштуваннях.
