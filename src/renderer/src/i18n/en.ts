...
export const en: Translation = {
  ...
  gameCard: {
    ...
    statusOrphaned: 'Removed from group',
  ...
  friends: {
    ...
    noStorage: "You don't have storage yet. Connect to a friend's below, or create your own in Settings.",
  ...
  notifications: {
    ...
    gameRemovedTitle: 'Game removed from the group',
    gameRemovedBody: (game) => `"${game}" was removed from the co-op group. Your own files are untouched.`,
  ...
  settings: {
    ...
    adoptRepoDesc:
      "Your PC already has the full version history of this storage. You can turn it into your own, separate storage under your account — with every version, not just the current save. If you already have your own storage, its content will be replaced by this. Friends would need to be re-invited there.",
