...
// Іконка трею як base64 PNG (32×32) — щоб не залежати від файлів і шляхів
// у dev/prod. Синє коло з літерою «C».
...
// Мінімальний окремий i18n для трею (не залежить від renderer/i18n — той
// живе в іншому бандлі й тягне зайве). Той самий набір мов, що й в UI.
...
/** Створює іконку в треї. Викликати один раз при старті. */
...
/** Перемалювати тултип і меню трею новою мовою (без перестворення іконки). */
