...
export const uk: Translation = {
  ...
  settings: {
    ...
    adoptRepoDesc:
      'На твоєму ПК вже лежить повна історія версій цього сховища. Можна перетворити її на власне, окреме сховище під твоїм акаунтом — з усіма версіями, а не тільки поточним сейвом. Друзів доведеться запросити туди заново.',
  ...
  errors: {
    ...
    HOST_REPO_ALREADY_EXISTS: () => 'У тебе вже є власне сховище — спочатку розберись з ним у Налаштуваннях',
