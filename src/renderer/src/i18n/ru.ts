...
export const ru: Translation = {
  ...
  history: {
    ...
    excludeFilesHint:
      'Отметь здесь файлы, которые не должны синхронизироваться — локальные настройки, данные аккаунта, всё, что на самом деле не является сохранением. В списке только файлы прямо в папке сохранений (без подпапок).',
