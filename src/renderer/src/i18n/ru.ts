...
export const ru: Translation = {
  ...
  settings: {
    ...
    adoptRepoDesc:
      'На твоём ПК уже лежит полная история версий этого хранилища. Можно превратить её в собственное, отдельное хранилище под твоим аккаунтом — со всеми версиями, а не только текущим сейвом. Друзей придётся пригласить туда заново.',
  ...
  errors: {
    ...
    HOST_REPO_ALREADY_EXISTS: () => 'У тебя уже есть собственное хранилище — сначала разберись с ним в Настройках',
